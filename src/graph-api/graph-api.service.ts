...
export class GraphApiService {
  ...
  getListItem = async (options: {
    ...
    return this.graph_client
      .api(
        `https://graph.microsoft.com/beta/sites/${options.siteId}/lists/${options.listId}/items/${options.itemId}?expand=fields`
      )
      .get();
  };
  ...
  getListColumns = async <T>(options: {
    ...
    return this.graph_client
      .api(
        `https://graph.microsoft.com/beta/sites/${options.siteId}/lists/${options.listId}/columns`
      )
      .get() as Promise<T>;
  };
  ...
  createListItemFile = async (options: {
    ...
    return this.graph_client
      .api(
        `https://graph.microsoft.com/beta/sites/${options.siteId}/drives/${options.driveId}/items/${options.itemId}:/${options.fileName}:/content`
      )
      .put(options.file);
  };
  ...
  createListItem = async (options: {
    ...
    return this.graph_client
      .api(
        `https://graph.microsoft.com/beta/sites/${options.siteId}/lists/${options.listId}/items`
      )
      .post(options.body);
  };
}
